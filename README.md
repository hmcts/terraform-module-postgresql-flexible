...
| <a name="input_restore_time"></a> [restore\_time](#input\_restore\_time) | The point in time to restore from. Only used when create mode is set to PointInTimeRestore | `any` | `null` | no |
