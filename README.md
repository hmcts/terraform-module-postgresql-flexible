...
| [azurerm_data_protection_backup_policy_postgresql_flexible_server.main](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/data_protection_backup_policy_postgresql_flexible_server) | data source |
...
| <a name="input_backup_policy_name"></a> [backup\_policy\_name](#input\_backup\_policy\_name) | Name of the backup policy within the backup vault. | `string` | `"postgresql-crit4-5"` | no |
...
| <a name="input_backup_vault_name"></a> [backup\_vault\_name](#input\_backup\_vault\_name) | Name of the Azure Data Protection Backup Vault. | `string` | `"cnp-backup-vault"` | no |
| <a name="input_backup_vault_resource_group_name"></a> [backup\_vault\_resource\_group\_name](#input\_backup\_vault\_resource\_group\_name) | Name of the resource group containing the backup vault. | `string` | `"mgmt-infra-prod-rg"` | no |
