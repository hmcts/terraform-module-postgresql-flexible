...
| <a name="input_backup_vault_principal_id"></a> [backup\_vault\_principal\_id](#input\_backup\_vault\_principal\_id) | Principal ID of the backup vault's managed identity. Update if vault is recreated. | `string` | `"851fbf32-435f-454f-9bca-86cda520f567"` | no |
