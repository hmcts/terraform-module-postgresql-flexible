...
| <a name="input_high_availability"></a> [high\_availability](#input\_high\_availability) | Enable high availability mode for the PostgreSQL Flexible Server. | `bool` | `false` | no |
