...
variable "pgsql_databases" {
  ...
  type        = list(object({ name : string, collation : optional(string), charset : optional(string), report_privilege_schema : optional(string), report_privilege_tables : optional(list(string)) }))
}
