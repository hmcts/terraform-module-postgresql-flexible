locals {
  ...
  vnet_rg_name = var.project == "sds" ? "ss-${var.env}-network-rg" : "${var.project}-${local.network_env}-network-rg"
  vnet_name    = var.project == "sds" ? "ss-${var.env}-vnet" : "${var.project}-${local.network_env}-vnet"
